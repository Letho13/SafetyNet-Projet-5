...
public class GlobalServiceTest {
    ...
    void personsFireStationByStationNumberTest () {
        ...
        assertEquals("John", result.getPersonFireStationDTOList().get(0).getFirstName());
        assertEquals("Doe", result.getPersonFireStationDTOList().get(0).getLastName());
        assertEquals("123 test", result.getPersonFireStationDTOList().get(0).getAddress());
        assertEquals("Jane", result.getPersonFireStationDTOList().get(1).getFirstName());
        assertEquals("Doe", result.getPersonFireStationDTOList().get(1).getLastName());
        assertEquals("123 test", result.getPersonFireStationDTOList().get(1).getAddress());
    }
